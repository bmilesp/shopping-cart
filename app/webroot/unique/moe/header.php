<div id="header" style="background-image:url('<?php echo "{$secureRootDir}unique/{$siteConfig->site}" ?>/img/header-background.gif')">
<?php if($this->name != "CakeError"){?>
	<div id='logo'><?php echo $html->image("{$secureRootDir}unique/{$siteConfig->site}/img/LogoMOE.png",array('url'=>array('controller'=>'pages','action'=>'home')))?></div>
	<div id="header_nav">
		<?php $headerNav = array();?>
